...
try:
    connector = pymysql.connect(host="localhost", user="root", password="", db=database_name)
    cursor = connector.cursor()
...
print("JDBC connection string : jdbc:mysql://localhost/{}?user=root".format(database_name))
