...
if user_name != "root":
    user_password = input("Enter the password for {} : ".format(user_name))
else:
    user_password = ""
...
print("#######################################################")
try:
    connector = pymysql.connect(host=bootstrap.host, user=user_name, password=user_password)
...
try:
    connector = pymysql.connect(host=bootstrap.host, user=user_name, password=user_password, db=database_name)
    cursor = connector.cursor()
